    ...
    public class XmlWritingTests
    {
        ...
        public void CreateHeader()
        {
            const string documentXml = "<Header><Author>Candace Cady</Author>" +
                                       ...
                                       "<ContactInfo>ccady@utah.gov</ContactInfo>" +
                                       "<Notification>ccady@utah.gov</Notification>" +
                                       "<Sensitivity>Unclasified</Sensitivity></Header>";
            ...
            var root = new XElement(XName.Get("Header"),
                ...
                new XElement(XName.Get("ContactInfo"),
                    "ccady@utah.gov"),
                new XElement(XName.Get("Notification"), "ccady@utah.gov"),
                new XElement(XName.Get("Sensitivity"), "Unclasified"));
        ...
        public void CreateHeaderInDocument()
        {
            const string documentXml =
                ...
                "<Organization>UDEQ</Organization>" +
                ...
                "<ContactInfo>ccady@utah.gov</ContactInfo>" +
                "<Notification>ccady@utah.gov</Notification>" +
                "<Sensitivity>Unclasified</Sensitivity>" +
                "</Header></Document>";
